...
> **方法来源**
>
> 这套方法源自 Kim Beverett（OpenAI）在 Config 2026 的演讲 *Be the Director: How Stage Craft Informs Product Craft*，由「AI Builders 解读 02」进一步转化为可直接使用的产品取舍、五秒测试和用户观察工具。
>
> [观看 YouTube 原演讲](https://www.youtube.com/watch?v=lr7jom1NHzg) · [查看 Config 2026 官方页面](https://config.figma.com/san-francisco/session/8f2835f5-9701-4834-9237-0621882953fa/)
...
https://github.com/Elisedai1013/ai-product-direction-skill/tree/main/skills/ai-builder-director
```
...
「一句话取舍模板」「五秒第一印象测试」和「用户试用观察表」是「AI Builders 解读 02」根据原演讲整理出的实践工具，并非 Kim Beverett 在原演讲中的正式命名。本仓库与原演讲者及其所在机构不存在官方隶属或背书关系。
